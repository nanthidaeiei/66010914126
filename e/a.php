...
<head>
<meta charset="utf-8">
<title>66010914126 นันธิดา ไชยนรา (แพม)</title>

<style>
    body {
        font-family: "Prompt", sans-serif;
        background-color: #17C763FF ; 
        margin: 0;
        padding: 0;
    }
    ...
    input, textarea, select {
        ...
        margin: 8px 0 15px 0;
        border-radius: 8px;
        border: 1px solid #6BFFC1FF;
        font-size: 16px;
    }

    button {
        background-color: #55EAB8A4;
        border: none;
        padding: 10px 15px;
        border-radius: 8px;
        color: white;
    ...
    button:hover {
        background-color: #4aa08A36AFF3f0;
    }
...
<h1>ฟอร์มรับข้อมูล - นันธิดา ไชยนรา (แพม) by GPT</h1>
